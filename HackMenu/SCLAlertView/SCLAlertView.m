...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    [noScreenShotView addSubview:_contentView];
    [noScreenShotView addSubview:_circleViewBackground];
...
- (SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    UIImage *iconImage;
    //随机颜色
    NSArray *array = [[NSArray alloc] initWithObjects:@"0x22B573",@"0xC1272D",@"0x727375",@"0xFFD110",@"0x2866BF",@"0xA429FF",@"0x6c125d",@"0x727375",@"0xCEFB8C",@"0xB3EE3A",@"0x7FFFD4",@"0x00FFFF",@"0xFFFF00",@"0xB0E0E6",@"0xCAFF70",@"0x98F5FF",@"0xEE0000",@"0xCDAA7D"@"0xB4CDCD"@"0xA0522D"@"0xCDC1C5"@"0x68838B"@"0xFF7F00"@"0xBDB76B"@"0xA2CD5A"@"0x8B475D"@"0x458B00",nil];
    NSMutableSet *randomSet = [[NSMutableSet alloc] init];
    int r = arc4random() % [array count];
    [randomSet addObject:[array objectAtIndex:r]];
    int randomArray = [randomSet allObjects];
    ...
    switch (style)
    {
        case SCLAlertViewStyleSuccess:
            viewColor = UIColorFromHEX(randomArray);
